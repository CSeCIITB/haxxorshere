...
js_content = '''// Challenge Matrix - Main JavaScript Logic
...
function showModal(challenge) {
    ...
    downloadBtn.disabled = !challenge.completed;
    downloadBtn.innerHTML = challenge.completed ? 
        '📁 Download Challenge' : 
        '🔒 Complete Challenge to Download';
